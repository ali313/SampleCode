...
public class RowLayout extends ViewGroup
{
    ...
    public RowLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr)
    {
        ...
        TypedArray styledAttributes = context.obtainStyledAttributes(attrs, R.styleable.RowLayout, defStyleAttr, 0);
    ...
    {
        final int widthOffset = getPaddingLeft();
        int x = getMeasuredWidth() - getPaddingRight();
        int y = getPaddingTop();
